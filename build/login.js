...
exports.searchSongTitleInGoogleImages = void 0;
var webPage;
function downloadThumbnails(page, listSongsTitles) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, getThumbnailUrl(listSongsTitles[i])];
                case 2:
                    _a.sent();
                    _a.label = 3;
                case 3:
...
function getThumbnailUrl(songTitle) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
...
exports.searchSongTitleInGoogleImages = searchSongTitleInGoogleImages;
